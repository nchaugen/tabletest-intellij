...
public class TableTestHeaderRowImpl extends ASTWrapperPsiElement implements TableTestHeaderRow {

  public TableTestHeaderRowImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<TableTestHeader> getHeaderList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, TableTestHeader.class);
  }
